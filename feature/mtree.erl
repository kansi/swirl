...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% @doc Takes input a list of indexes or bin numbers and constructs a tree
%% using the leaf nodes sotred in the ETS table and store the tree back into
%% the ETS table.
%% @end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% @doc insert/2 add new chunk hash, bin number of the hash, starting bin
%% number of the range represented by this bin number and lenght of the range
%% <p> Provides interface to insert hashs into the ETS table. </p>
%% @end
-spec insert(mtree(), binary()) -> mtree().
insert(_Tree, _Leaf) -> ok.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% @doc remove/2 removes a given hash from tree and re-calculate the root hash
%% @end
...
%% received Root_Hash.
%% <p> When a peer receives a new chunk it MUST recieve Uncle_Hashes required
...
%% File_Name. Reutrns ok if the operation succeded.
%% @end
...
%% @doc
%% @end
%-spec padding(integer()) -> integer() | ok.
%padding(_Tree) -> ok.
